...
class ItemPopularMoviesAdapter(private val listItem: List<ResultsPopularFavoriteSimilar>, private val listItem2: List<ResultsItemRated>, private val listItem3: List<ResultsPopularFavoriteSimilar>): RecyclerView.Adapter<ItemPopularMoviesAdapter.ViewHolder>() {
